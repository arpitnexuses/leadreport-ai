...
interface ProjectLeadTableProps {
  projectLeads: ProjectLeadCount[];
}

export function ProjectLeadTable({ projectLeads }: ProjectLeadTableProps) {
      ...
      <CardHeader className="pb-2 bg-[#1E3FAC] text-white rounded-t-xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-xl text-white">Project Lead Distribution</CardTitle>
